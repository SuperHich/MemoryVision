 ...
 * Time: 12:31 PM
 */
public class CustomDynamicGridView extends GridView
{
...
//            mIsEditMode = true;
    ...
    public CustomDynamicGridView(Context context)
    {
        super(context);
        init(context);
    }

    public CustomDynamicGridView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context);
    }

    public CustomDynamicGridView(Context context, AttributeSet attrs, int defStyle)
    {
